...
The summary of the overall procedure duration is;

```{r ortho_case_count_2, echo=FALSE, warning=FALSE, message=FALSE}
summary(Ortho_list$Op_duration)
```

But for acute procedures only

```{r ortho_case_count_3, echo=FALSE, warning=FALSE, message=FALSE}
Ortho_acute <- Ortho_list %>% 
  filter(Modified == "AC")
